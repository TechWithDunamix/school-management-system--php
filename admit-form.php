...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/admit-form.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 12:34:53 GMT -->
...
<head>
	...
	<script type="module" src="js/custom/admit-form.js"></script>
			...
			<div class="dashboard-content-one">
				...
				<div class="card height-auto">
					<div class="card-body">
						...
						<form class="new-added-form" id="admit-form" method="POST">
							<div class="row">
								...
								<div class="col-xl-3 col-lg-6 col-12 form-group">
									...
									<input name="date_of_birth" type="date" placeholder="dd/mm/yyyy" required>
								</div>

								<div class="col-xl-3 col-lg-6 col-12 form-group">
									<label>Class *</label>
									<select name="class" class="select2">
										<option value="" disabled selected hidden>Please Select Class *</option>
								...
								<div class="col-xl-3 col-lg-6 col-12 form-group">
									...
									<input name="parent_full_name" type="text" class="form-control" required>
								</div>

								<div class="col-xl-3 col-lg-6 col-12 form-group">
									<label>Parent Phone Number</label>
									<input name="parent_phone" type="number" class="form-control" required>
								</div>

								<div class="col-12 form-group mg-t-8">
									<button id="submit-button" type="submit" class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Save</button>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/admit-form.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 31 May 2024 12:34:57 GMT -->
